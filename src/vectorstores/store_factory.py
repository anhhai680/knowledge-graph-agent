...
class VectorStoreFactory:
    ...
    def _create_pinecone_store(
        ...
        **kwargs
        ...
        coll_name = collection_name or settings.pinecone.collection_name if settings.pinecone else None
    ...
    def from_documents(
        ...
        **kwargs
        ...
        if db_type == DatabaseType.CHROMA:
            ...
            coll_name = collection_name or settings.pinecone.collection_name if settings.pinecone else None
            api_key = kwargs.get("api_key") or settings.pinecone.api_key if settings.pinecone else None
