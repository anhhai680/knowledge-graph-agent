...
class DocumentProcessor:
    ...
    def __init__(
        ...
        logger.debug(f"Initialized document processor with chunk_size={self.chunk_size}, chunk_overlap={self.chunk_overlap}")
    ...
    def process_document(self, document: Document) -> List[Document]:
        ...
        logger.debug(f"Processing document with language={language}, file_path={file_path}")
